...
import { getMemorySystem } from '../../ai-engine/src/MemorySystem'
import { getDialogueEngine } from '../../ai-engine/src/DialogueEngine'

const _easterEggs: string[] = []
function foundEasterEgg(id: string) { if (_easterEggs.includes(id)) return false; _easterEggs.push(id); return true }
